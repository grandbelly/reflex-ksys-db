...
- FIXED: 100% cap for overall_success_rate (2025-11-26)
- FIXED: influx_agg_1m 기반 서비스 사용 (2025-11-26)
"""
import reflex as rx
import pandas as pd
import numpy as np
...
class CommunicationState(rx.State):
    ...
    def overall_success_rate(self) -> float:
        ...
        if expected_records > 0:
            rate = round(float(total_records / expected_records) * 100, 2)
